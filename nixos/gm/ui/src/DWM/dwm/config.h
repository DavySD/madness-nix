...
static const char *fonts[]          = { "Hurmit Nerd Font:style=Bold:size=12" };
static const char *colors[][3] = {
    /*                 fg         bg         border   */
    [SchemeNorm] = { "#6b6052", "#0f0f0f", "#2e2820" }, 
    [SchemeSel]  = { "#d4c5a9", "#1a1612", "#c4633a" }, // ferrugem viva na borda!
};
